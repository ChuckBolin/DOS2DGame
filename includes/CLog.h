...
public:
  ...
  void LogPair(T1 value1, T2 value2, T3 value3);
  
  template <typename T1, typename T2, typename T3, typename T4> 
  void LogTriplet(T1 value1, T2 value2, T3 value3, T4 value4);
...
template <typename T1, typename T2, typename T3>
void CLog::LogPair(T1 value1, T2 value2, T3 value3){
  std::ofstream file;
  file.open(m_filename.c_str(), std::ios_base::app);
...
template <typename T1, typename T2, typename T3, typename T4> 
void CLog::LogTriplet(T1 value1, T2 value2, T3 value3, T4 value4){
  std::ofstream file;
  file.open(m_filename.c_str(), std::ios_base::app);
